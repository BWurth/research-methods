...
Let's apply the same comprehensive analysis to our second research question about control levels:
...
Now let's examine our second research question about control levels between genders:
...
```r
# View the first few rows using head()
head(staff_survey_dat)

# Examine the structure
str(staff_survey_dat)

# Get basic summary statistics
summary(staff_survey_dat)
```
...
```r
#| fig-cap: "Distribution of Years of Service"
